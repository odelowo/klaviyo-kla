<?php
$title = 'Answered Questions'; //used to identify user friendly in-page title
$pageTitle = 'Answered Questions'; //used to identify page title
$menuItemSelected = 'answered-questions'; //used to identify which menu item is preselected
